...
def get_random_password():
    ...
    return "".join(choice(valid_character_for_password+onenumber) for each_char in range(len_of_password))
...
def main():
    ...
    try:
        ...
        if e.response['Error']['Code'] == "EntityAlreadyExists":
            ...
            print(e)
            sys.exit(0)
    response = iam_ob_cli.create_access_key(UserName=Iam_user_name)
